...
// Multilingual chatbot UI strings
const chatUI = {
  en: {
    welcome: "👋 Hello! I'm your NPS Assistant. Ask me anything about pensions, KYC, or investing.",
    placeholder: "Type or speak your question...",
    quick: [
      { label: 'What is NPS?', query: 'What is NPS?' },
      { label: 'Open Account', query: 'How to open account?' },
      { label: 'Tax Benefits', query: 'What are tax benefits?' },
      { label: 'What is PRAN?', query: 'What is PRAN?' },
      { label: 'Min Amount?', query: 'Minimum contribution?' }
    ]
  },
  hi: {
    welcome: "👋 नमस्ते! मैं आपका NPS सहायक हूँ। पेंशन, KYC या निवेश के बारे में कुछ भी पूछें।",
    placeholder: "अपना सवाल टाइप करें या बोलें...",
    quick: [
      { label: 'NPS क्या है?', query: 'nps क्या है' },
      { label: 'खाता खोलें', query: 'खाता कैसे खोलें' },
      { label: 'कर लाभ', query: 'कर लाभ' },
      { label: 'PRAN क्या है?', query: 'pran क्या है' },
      { label: 'न्यूनतम राशि?', query: 'न्यूनतम योगदान' }
    ]
  },
  gu: {
    welcome: "👋 નમસ્તે! હું તમારો NPS સહાયક છું। પેન્શન, KYC કે રોકાણ વિશે કંઈ પણ પૂછો.",
    placeholder: "તમારો પ્રશ્ન ટાઈપ કરો અથવા બોલો...",
    quick: [
      { label: 'NPS શું છે?', query: 'nps શું છે' },
      { label: 'ખાતું ખોલો', query: 'ખાતું કેવી રીતે ખોલવું' },
      { label: 'કર લાભ', query: 'કર લાભ' },
      { label: 'ઉપાડ', query: 'ઉપાડ' },
      { label: 'મદદ', query: 'મદદ' }
    ]
  },
  ta: {
    welcome: "👋 வணக்கம்! நான் உங்கள் NPS உதவியாளர். ஓய்வூதியம், KYC அல்லது முதலீடு பற்றி கேளுங்கள்.",
    placeholder: "உங்கள் கேள்வியை டைப் செய்யுங்கள் அல்லது பேசுங்கள்...",
    quick: [
      { label: 'NPS என்ன?', query: 'nps என்றால் என்ன' },
      { label: 'கணக்கு திறப்பு', query: 'கணக்கு திறப்பது எப்படி' },
      { label: 'வரிச் சலுகை', query: 'வரிச் சலுகை' },
      { label: 'திரும்பப் பெறுதல்', query: 'திரும்பப் பெறுதல்' },
      { label: 'உதவி', query: 'உதவி' }
    ]
  },
  te: {
    welcome: "👋 హలో! నేను మీ NPS సహాయకం. పెన్షన్, KYC లేదా పెట్టుబడి గురించి అడగండి.",
    placeholder: "మీ ప్రశ్నను టైప్ చేయండి లేదా మాట్లాడండి...",
    quick: [
      { label: 'NPS అంటే?', query: 'nps అంటే ఏమిటి' },
      { label: 'ఖాతా తెరవడం', query: 'ఖాతా ఎలా తెరవాలి' },
      { label: 'పన్ను ప్రయోజనాలు', query: 'పన్ను ప్రయోజనాలు' },
      { label: 'ఉపసంహరణ', query: 'ఉపసంహరణ' },
      { label: 'సహాయం', query: 'సహాయం' }
    ]
  },
  kn: {
    welcome: "👋 ನಮಸ್ಕಾರ! ನಾನು ನಿಮ್ಮ NPS ಸಹಾಯಕ. ಪಿಂಚಣಿ, KYC ಅಥವಾ ಹೂಡಿಕೆ ಬಗ್ಗೆ ಕೇಳಿ.",
    placeholder: "ನಿಮ್ಮ ಪ್ರಶ್ನೆ ಟೈಪ್ ಮಾಡಿ ಅಥವಾ ಮಾತನಾಡಿ...",
    quick: [
      { label: 'NPS ಏನು?', query: 'nps ಏನು' },
      { label: 'ಖಾತೆ ತೆರೆಯಿರಿ', query: 'ಖಾತೆ ತೆರೆಯುವುದು ಹೇಗೆ' },
      { label: 'ತೆರಿಗೆ ಪ್ರಯೋಜನ', query: 'ತೆರಿಗೆ ಪ್ರಯೋಜನ' },
      { label: 'ಹಿಂಪಡೆಯುವಿಕೆ', query: 'ಹಿಂಪಡೆಯುವಿಕೆ' },
      { label: 'ಸಹಾಯ', query: 'ಸಹಾಯ' }
    ]
  },
  or: {
    welcome: "👋 ନମସ୍କାର! ମୁଁ ଆପଣଙ୍କ NPS ସହାୟକ। ପେନସନ, KYC ବା ବିନିଯୋଗ ବିଷୟରେ ପଚାରନ୍ତୁ।",
    placeholder: "ଆପଣଙ୍କ ପ୍ରଶ୍ନ ଟାଇପ କରନ୍ତୁ ବା କୁହନ୍ତୁ...",
    quick: [
      { label: 'NPS କଣ?', query: 'nps କଣ' },
      { label: 'ଖାତା ଖୋଲନ୍ତୁ', query: 'ଖାତା ଖୋଲିବା' },
      { label: 'କର ସୁବିଧା', query: 'କର ସୁବିଧା' },
      { label: 'ଉଠାଣ', query: 'ଉଠାଣ' },
      { label: 'ସାହାଯ୍ୟ', query: 'ସାହାଯ୍ୟ' }
    ]
  }
};

// Populate chatbot welcome & quick actions in current language
function initChatbotUI() {
  const lang = state.language || 'en';
  const ui = chatUI[lang] || chatUI['en'];
  const welcome = $('#chatWelcome');
  if (welcome) {
    welcome.innerHTML = ui.welcome +
      '<div class="chat-quick-actions">' +
      ui.quick.map(q => `<button class="chat-quick-btn" onclick="askBot('${q.query}')">${q.label}</button>`).join('') +
      '</div>';
  }
...
voiceFab.addEventListener('click', () => {
  initChatbotUI(); // refresh language each time panel opens
